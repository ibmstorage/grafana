...
const DataLink = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className }, /* @__PURE__ */ React.createElement("div", { className: styles.firstRow + " gf-form" }, /* @__PURE__ */ React.createElement(
    FormField,
    {
    ...
    FormField,
    {
      ...
      labelWidth: 6,
      inputEl: /* @__PURE__ */ React.createElement(
        DataLinkInput,
        {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: styles.row }, /* @__PURE__ */ React.createElement(
    Switch,
    {
      labelClass: "width-6",
      label: "Internal link",
  ...
  ), showInternalLink && /* @__PURE__ */ React.createElement(
    DataSourcePicker,
    {
      onChange: (ds) => {
        onChange({
