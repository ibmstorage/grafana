...
function QueryHeader({
  ...
  )), editorMode === EditorMode.Builder && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Space, { v: 0.5 }), /* @__PURE__ */ React.createElement(EditorRow, null, catalogsEnabled && /* @__PURE__ */ React.createElement(EditorField, { label: labels.get("catalog") || "Catalog", width: 25 }, /* @__PURE__ */ React.createElement(
    CatalogSelector,
    {
      db,
